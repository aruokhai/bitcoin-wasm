    ...
    pub mod node {
        ...
        pub mod types {
            ...
            pub type OfferingBargain =
                super::super::super::component::tbdex::types::OfferingBargain;
            #[repr(u8)]
            ...
            impl Node {
                ...
                pub fn get_balance(&self) -> Result<i64, Error> {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "component:node/types@0.1.0")]
                        extern "C" {
                            #[link_name = "[method]node.get-balance"]
            ...
            impl Node {
                ...
                pub fn get_conversion_offer(&self) -> Result<OfferingBargain, Error> {
                    unsafe {
                        ...
                        #[link(wasm_import_module = "component:node/types@0.1.0")]
                        extern "C" {
                            #[link_name = "[method]node.get-conversion-offer"]
                            fn wit_import(_: i32, _: *mut u8);
                        }
            ...
            impl Node {
                ...
                pub fn convert_amount(
                    ...
                    unsafe {
                        ...
                        #[link(wasm_import_module = "component:node/types@0.1.0")]
                        extern "C" {
                            #[link_name = "[method]node.convert-amount"]
                            fn wit_import(
                                _: i32,
                                _: *mut u8,
                                _: usize,
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xae\x0a\x01A\x02\x01\
A\x09\x01B\x12\x01r\x02\x03keys\x05values\x04\0\x0ekey-value-pair\x03\0\0\x01m\x01\
...
de.convert-amount\x01\x18\x03\x01\x1acomponent:node/types@0.1.0\x05\x02\x01B\x13\
\x01r\x02\x03keys\x05values\x04\0\x0ekey-value-pair\x03\0\0\x01s\x04\0\x03key\x03\
\0\x02\x01m\x01\x03nae\x04\0\x05error\x03\0\x04\x04\0\x05store\x03\x01\x01i\x06\x01\
@\0\0\x07\x04\0\x12[constructor]store\x01\x08\x01h\x06\x01j\0\x01\x05\x01@\x02\x04\
self\x09\x02kv\x01\0\x0a\x04\0\x14[method]store.insert\x01\x0b\x01j\x01\x01\x01\x05\
...
\x1bcomponent:store/types@0.1.0\x05\x03\x01@\0\x01\0\x04\0\x04test\x01\x04\x04\x01\
