...
) -> Result<BTreeMap<String, String>, DocumentPacketError> {
...
/// Get value from the RData BTreeMap created by record_rdata_to_hash_map().
/// Convert `None` into DocumentPacketError
pub fn get_rdata_txt_value(
    rdata_map: &BTreeMap<String, String>,
    key: &str,
