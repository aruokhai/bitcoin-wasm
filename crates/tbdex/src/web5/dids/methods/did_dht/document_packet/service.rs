...
use crate::web5::dids::data_model::service::Service;
...
impl TryFrom<BTreeMap<String, String>> for ServiceRdata {
    fn try_from(rdata_map: BTreeMap<String, String>) -> Result<Self, Self::Error> {
        Ok(ServiceRdata {
