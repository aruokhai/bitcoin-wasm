...
impl CoinSelectionAlgorithm for OldestFirstCoinSelection {
    fn coin_select<R: RngCore>(
        ...
        let utxos = {
            optional_utxos.sort_unstable_by_key(|wu| wu.utxo.chain_position);
...
//         let utxo1 = confirmed_utxo(Amount::from_sat(120_000), 1, 1);
//         let utxo2 = confirmed_utxo(Amount::from_sat(80_000), 2, 2);
//         let utxo3 = confirmed_utxo(Amount::from_sat(300_000), 3, 3);
