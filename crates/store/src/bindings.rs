...
pub mod exports {
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "component:store/types#[constructor]store"]
    ...
    #[export_name = "component:store/types#[method]store.insert"]
    ...
    #[export_name = "component:store/types#[method]store.search"]
    ...
    #[export_name = "cabi_post_component:store/types#[method]store.search"]
    ...
    #[export_name = "component:store/types#[method]store.delete"]
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "component:store/types#[dtor]store"]
      #[allow(non_snake_case)]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xe6\x04\x01A\x02\x01\
A\x08\x01B\x13\x01r\x02\x03keys\x05values\x04\0\x0ekey-value-pair\x03\0\0\x01s\x04\
...
\x01\x0e\x03\x01\x15component:store/types\x05\0\x02\x03\0\0\x05store\x03\0\x05st\
ore\x03\0\x01\x02\x03\0\0\x05error\x03\0\x05error\x03\0\x03\x01B\x13\x01r\x02\x03\
keys\x05values\x04\0\x0ekey-value-pair\x03\0\0\x01s\x04\0\x03key\x03\0\x02\x01m\x01\
\x03nae\x04\0\x05error\x03\0\x04\x04\0\x05store\x03\x01\x01i\x06\x01@\0\0\x07\x04\
\0\x12[constructor]store\x01\x08\x01h\x06\x01j\0\x01\x05\x01@\x02\x04self\x09\x02\
kv\x01\0\x0a\x04\0\x14[method]store.insert\x01\x0b\x01j\x01\x01\x01\x05\x01@\x02\
\x04self\x09\x03key\x03\0\x0c\x04\0\x14[method]store.search\x01\x0d\x01@\x02\x04\
self\x09\x03key\x03\0\x0a\x04\0\x14[method]store.delete\x01\x0e\x04\x01\x15compo\
nent:store/types\x05\x05\x04\x01\x15component:store/store\x04\0\x0b\x0b\x01\0\x05\
store\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.208.\
